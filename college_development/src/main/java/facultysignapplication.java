...
/**
 * Servlet implementation class facultysignapplication
 */
@WebServlet("/facultysignapplication")
public class facultysignapplication extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public facultysignapplication() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
	        ...
	        PreparedStatement pp=connection.prepareStatement("insert into faculty values(?,?,?);");
	        pp.setString(1, uid);
